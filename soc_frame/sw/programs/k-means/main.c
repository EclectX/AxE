...
{
    uint32_t x;  /**< abscissa of 2D data point */
    uint32_t y;  /**< ordinate of 2D data point */
...
{
    uint32_t x;     /**< abscissa centroid of this cluster */
    uint32_t y;     /**< ordinate of centroid of this cluster */
...
{
    uint32_t minD = DBL_MAX;
    uint32_t dist = 0x00000000;
    int index = -1;
    int i = 0;
    for (; i < k; i++)
    {
