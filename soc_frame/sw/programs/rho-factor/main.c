    ...
    do  if (n < 4)
            *array++ = n, n = 1;
            ...
            if (b * b == n) {
                ...
                memmgr_memcpy(array + s, array, s * sizeof(positive_number)) ;
                array += s + s ;
                n = 1;
            } else {
...
void my_main()
{
    ...
    positive_number *factors = memmgr_calloc(64, sizeof(positive_number)), n = 0, mask = -1;
