...
{
	prgs[0].name = "msort";
	prgs[0].addr[ARCH_RV32IM] = 0x100000; // index: 262144 size: 3340
	...
	prgs[0].d_multiplyer = 0b0000000110000110;
	prgs[0].s          = 5;
	prgs[0].s_cnt_down = 5;
	...
	prgs[1].name = "qsort";
	prgs[1].addr[ARCH_RV32IM] = 0x1055c0; // index: 267632 size: 2410
	...
	prgs[1].d_multiplyer = 0b0000000101010100;
	prgs[1].s          = 5;
	prgs[1].s_cnt_down = 5;
